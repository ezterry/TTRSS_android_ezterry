...
import name.devnull.ttrss.CommonActivity;
import name.devnull.ttrss.PreferencesActivity;
...
public class OfflineActivity extends CommonActivity {
	...
	private void switchOnline() {
		...
		Intent refresh = new Intent(this, name.devnull.ttrss.OnlineActivity.class);
