...
import name.devnull.ttrss.util.DatabaseHelper;
import name.devnull.ttrss.util.ImageCacheService;
...
public class OfflineDownloadService extends Service {
	...
	public static final String INTENT_ACTION_SUCCESS = "name.devnull.ttrss.intent.action.DownloadComplete";
	public static final String INTENT_ACTION_CANCEL = "name.devnull.ttrss.intent.action.Cancel";
	...
	private boolean isCacheServiceRunning() {
	    ...
	    for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
	        if ("name.devnull.ttrss.ImageCacheService".equals(service.service.getClassName())) {
	            return true;
	        }
	    }
	    return false;
